...
@lexer::header {
module antlr.rutime.tests.t017llstarLexer;
}

@parser::header {
module antlr.rutime.tests.t017llstarParser;
...
@parser::members {
  ...
  public LinkedList!(immutable(char_t)[]) output;
        }
...
declaration
    :   variable
    |   functionHeader ';'
	{output.append($functionHeader.name~" is a declaration");}
    |   functionHeader block
	{output.append($functionHeader.name~" is a definition");}
    ;
