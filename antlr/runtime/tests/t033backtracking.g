...
@lexer::header {
module antlr.runtime.tests.t033backtrackingLexer;
        }


@parser::header {
module antlr.runtime.tests.t033backtrackingParser;
import tango.util.container.HashSet;
alias HashSet!(wchar[]) Set;
// compatibility stuff
/*
try:
    set = set
...
try:
    ...
    Symbols_stack_t reversed(Symbols_stack_t l) {
        l = l[:]
        l.reverse()
        return l
            }
...
@parser::members {
    bool isTypeName(wchar[] name) {
        foreach_reverse(s;Symbols_stack){
...
direct_declarator
	:   (	IDENTIFIER
			...
			if (($declaration.size>0) && ($declaration::isTypedef)) {
				...
				Stdout("define type ")($IDENTIFIER.text).newline;
            }
			}
		|	'(' declarator ')'
		)
